...
\newglossaryentry{SNN} {
  name = SNN,
  first = {spiking neural networks (SNN)},
  description = {A neural network where the nodes (neurons) communicate via pulses of signals
                 over time, as opposed to layered and/or single-pass networks}
}
