...
Futhark \index{Futhark} through \gls{OpenCL},
NEST \index{NEST} through PyNN \index{PyNN} and BrainScaleS
\index{BrainScaleS} through PyNN.
...
learning through backpropagation \index{backpropagation} for second
