...
\subsection{Learning} \index{learning}
Within the cognitive sciences learning within an \texit{agent} \gls{agent}
refers to ``the process of gaining
information through observation'' \cite{sep:learning-formal}.
Following the above abstraction of neural networks, ``learning'' in this 
thesis \index{learning}
simply refers to the development of consistent patterns, given the same input.
These patterns can be understood as general functions or rules, which
may, of course, prove to be incorrect \cite[p. 704.]{Russel2007}. 

Within machine learning \index{machine learning} three types of
...
\textit{Reinforcement} learning the \gls{agent} is reinforced through
rewards and discouraged through punishments \cite{Russel2007}.
...
Further, the process of learning can either be \textit{inductive}
...
\subsubsection{Learning in second generation \gls{NN}}
...
Because \gls{NN}s are not directly rule-based knowledge representations,
this thesis focuses on induction learning, and since 
