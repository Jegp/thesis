...
TODO
%Because of the limits of the BrainScaleS platform a number of steps have to be
%performed to correctly evaluate the experiments on the wafers.
%Firstly the weights have to be discretised to . . 
%TODO
