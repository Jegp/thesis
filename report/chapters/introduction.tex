...
%TODO: Describe what is to be expected in the thesis
%TODO 
%Det ser godt ud synes jeg selvom det jo er vigtigt at du får forfattet en intro der sætter specialet i perspektiv, beskriver din tese, beskriver din test- og evalueringsform samt giver en læsevejledning til læseren, som vi snakkede om. Således handler tests om hvorvidt det du har lavet virker og evalueringen handler om hvorvidt din tese kan bekræftes og i hvilken grad.

% Write: using hypothetical deductive method
\begin{comment}
...
%TODO: What will I do that is not done before
%   - What is the problem?
%   - Define problem statement
%TODO: Introductory state of the art
%   - DSL section is 
%TODO: Why is it interesting to look at these types of networks
